...
define config.name = _("Locked in the Mind Museum")
...
init python:
    style.button.hover_sound = "audio/sfx/Tap.mp3"
...
define config.main_menu_music = "audio/sfx/natby.ogg"
#define config.main_menu_music = "v.mp3"
...
define config.save_directory = "LITMMv1"
...
init python:
    ...
    build.classify('game/**.rpc', 'archive')
...
define config.layers = [ "master", "transient", "battle_sprites", "screens", "battle_anims", "overlay", "front" ]
